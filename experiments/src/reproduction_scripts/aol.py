...
def reproduce_experiments_on_aol_data():
    ...
    oracles_file_dir = os.path.join(settings.ORACLES_BASE_PATH, "AOL", f'days_{"_".join(str(day) for day in setup_by_seed[seeds[0]].days)}')
